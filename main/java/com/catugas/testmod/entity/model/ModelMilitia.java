package com.catugas.testmod.entity.model;
...
public class ModelMilitia extends ModelBase
{
    ...
    public ModelMilitia(float scale)
    {
        this(scale, 0.0F, 64, 64);
    }

    public ModelMilitia(float scale, float p_i1164_2_, int width, int height)
    {
