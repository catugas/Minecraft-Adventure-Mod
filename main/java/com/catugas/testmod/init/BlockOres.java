...
import com.catugas.testmod.objects.blocks.item.ItemBlockVariants;
import com.catugas.testmod.util.handlers.EnumHandler;
import com.catugas.testmod.util.interfaces.IHasModel;
import com.catugas.testmod.util.interfaces.IMetaName;
...
public class BlockOres extends Block implements IHasModel, IMetaName
{
	...
	public BlockOres(String name, String dimension) 
	{
		...
		setHardness(5.0F); // for now all custom ores have the same hardness...
		setResistance(15.0F); // ... and resistance as iron
		setHarvestLevel("pickaxe", 1); // sets Harvest Level for this class of custom ores
		// to create separate HL, HARD, RES, etc. - create new class and which extends this one.
